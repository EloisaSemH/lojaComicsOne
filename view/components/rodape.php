<footer id="dk-footer" class="dk-footer clearfix py-4">
    <div class="container">
        <div class="row py-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="footer-widget">
                            <div class="section-heading">
                                <h3>Subscribe</h3>
                                <span class="animate-border border-black text-light"></span>
                            </div>
                            <p>
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <span>Copyright © Flor de Cacto Comunicações. 2020 - <?= date('Y'); ?>. Todos os direitos reservados.</span>
                </div>
                <!-- End Col -->
                <div class="col-md-5">
