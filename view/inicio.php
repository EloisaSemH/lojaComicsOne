...
<!-- Page Content -->
<section class="py-5 text-center sectionInicio">
    <div class="container">
        <h2 class="text-center">Luckmoshy`s Services</h2>
        <p class="text-muted mb-5 text-center">There are many variations of passages of Lorem Ipsum available, but
            the
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-4 mb-3">
                ...
                <p class="text-muted">Ex cupidatat eu officia consequat incididunt labore occaecat ut veniam labore
                    et
                    cillum id et.</p>
            </div>
            <div class="col-sm-6 col-lg-4 mb-3">
            ...
            <div class="col-sm-6 col-lg-4 mb-3">
                ...
                <p class="text-muted">Voluptate ex irure ipsum ipsum ullamco ipsum reprehenderit non ut mollit
                    commodo.
                </p>
            </div>
            <div class="col-sm-6 col-lg-4 mb-3">
...
<section class="main sectionInicio">
    <div class="container mt-4">
        ...
        <div class="row">
            <div class="card-columns">
                ...
                <div class="card shadow border-0 bg-vermelho-claro text-white text-center p-3">
...
<!-- Header -->
<header class="bg-vermelho-claro text-center py-5 mb-4">
    <div class="container">
